    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-surface rounded-xl shadow-sm ring-1 ring-hairline">
        <form @submit.prevent="verify" class="p-8 space-y-6">
          ...
          <!-- Info Banner -->
          <div class="bg-primary-surface border border-primary/30 rounded-lg p-4">
            <div class="flex gap-3">
              ...
              <div>
                <p class="text-sm text-primary-on-surface">
                  Open your authenticator app and enter the 6-digit code.
                </p>
                <p class="text-xs text-primary-on-surface mt-1">
